...
public:
	std::string upKey, downKey, leftKey, rightKey, shootKey;
	...
	KeyboardControllerComponent(std::string upKey, std::string rightKey, std::string downKey, std::string leftKey, std::string shootKey) {
